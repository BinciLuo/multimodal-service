...
with gr.Blocks() as demo:
    ...
    with gr.Accordion("Auto", open=False):
        with gr.Tab("Gen Data"):
            ...
            Auto_GenChat_OpenAIKey = gr.Textbox(show_label=False, placeholder="OpenAI Key", lines=1, container=False, show_copy_button=True)
    ...
    Auto_GenChat_StartBtn.click(auto_gen_chat_data_process,[Auto_GenChat_FileExplorer, Auto_GenChat_NumSlider, Auto_GenChat_CoreSlider, Auto_GenChat_OpenAIKey],[])
